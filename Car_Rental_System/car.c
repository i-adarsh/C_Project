...
void addAdmin()
{
    FILE *fp=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/admin.bin", "rb");
    if(fp==NULL){
        fp=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/admin.bin", "wb");
       User u[2]={{"admin", "abc", "Ramesh"},{"admin", "abc", "Md Aftab Ahmad"}};
...
int checkUserExist(User u, char *usertype){
    ...
    if(!(strcmp(usertype, "admin"))){
        ...
        FILE *fp1=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/emp.bin", "rb");
          User user2;
...
void addCarDetails(){
         ...
         FILE *fp=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/car.bin", "rb");
    int id=1;
    char uchoice;
    Car c1,c2;
    ...
    if(fp==NULL){
        ...
        fp=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/car.bin", "ab");
        id=1;
        c1.car_id=id;
    ...
    do{
        ...
        *pos='\0';
        ...
        fflush(stdin);
        scanf("%d",&c1.capacity);
        printf(ANSI_COLOR_CYAN "Enter Number of Car:" ANSI_COLOR_RESET);
...
void addEmployee(){
    ...
    FILE *fp=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/emp.bin", "rb");
    int id;
    char uchoice;
    char emp[10]="EMP-";
    char empid[10];
    ...
    if(fp==NULL){
        ...
        fp=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/emp.bin", "ab");
        id=1;
...
FILE *fp1=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/car.bin", "rb");
...
gotoxy(32,1);
    ...
    FILE *fp2=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/temp.bin", "wb+");
    gotoxy(10,9);
    ...
    if(found==1){
        ...
        rewind(fp2);
        fp1=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/car.bin", "wb");
    ...
    fclose(fp2);
    remove("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/temp.bin");
    return found;
...
int deleteEmp(){
    ...
    if(found==1){
        ...
        rewind(fp2);
        fp1=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/emp.bin", "wb");
        while(fread(&U, sizeof(U), 1, fp2) ==1){
            fwrite(&U, sizeof(U), 1,fp1);
        }
        fclose(fp1);
...
void availableCarDetails(){
 ...
 static int a,b,I,s,r=0;
        int i=0;  int x=10;
    FILE *fp=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/customer.bin" , "rb");
     FILE *fp1=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/car.bin", "rb");
     Car ur;
...
int rentCar(){
    ...
    *pos='\0';
    ...
    FILE *fp=fopen("/Users/adarshkumar/Documents/C 2020 Project/CAR RENTAL/customer.bin" , "ab");
